...
/* $cliente=$sf_params->get('cliente');
  ...
  echo "Servicio:".$sf_params->get('tipo_servicio')."<br />";
            ...
            <div class="articleContentSector">
                ...
                <div class="breadcrumbBox">
                    <ul>
                        ...
                        <li class="last">Tipo Servicio + Incurrido + Nª de casos</li>
                    </ul>
                </div>
                <!-- TÍTULO DEL TEMA / TOPICO -->
                <h1 class="articleTitle">Tipo Servicio + Incurrido + Nª de casos</h1>
                <div class="articleBox">
                    <form  id="form1"  name="form1" action="<?php echo url_for('tralidadservincucasos/index') ?>" method="post">
                        <table>                      
...
<?php endforeach; ?>
                ...
                ['INCURRIDO - TOTAL '," . $totalmonto . "," . $totalcantidad . "],";
                                    ...
                                    if ($cuantos_tabla_inicial != 0) {
                                        ...
                                        foreach ($SINIESTRALIDAD_VW_tabla_inicial as $row_tabla):
                                            ...
                                            $var_srcipt = $var_srcipt . "['INCURRIDO - " . $tipo_serv . "'," . $monto_servicio . "," . $cantidad . "]";
          ...
          title: 'Tipo Servicio + Incurrido + Nª de casos',         
        ...
        chart.draw(data, options);
                                ...
                                <tfoot>
                                    ...
                                    <td>Total</td>
                                    <td class="alignRight"><?php echo number_format(str_replace(",", ".", $totalmonto), 2, ",", "."); ?></div></td>
                                    <td class="alignRight"><?php echo number_format(str_replace(",", ".", $totalcantidad), 2, ",", "."); ?></div></td>
                                    </tr>
                                </tfoot>
                            ...
                            <div style="height:420px; margin-left:15px; " align="left">
                            ...
                            <form method="post" id="targetpdf" action="<?php echo url_for('pdf/index') ?>" target="_blank" hidden="hidden">
                                <input id="titulo_pdf"  name="titulo_pdf" type="text" value="Tipo Servicio + Incurrido + Nª de casos" />
    ...
    <?php echo $var; ?>
                            ...
                            <form method="post" id="targetexcel" action="<?php echo url_for('excel/index') ?>" target="_blank" hidden="hidden">
                                <input id="titulo"  name="titulo" type="text" value="Tipo Servicio + Incurrido + Nª de casos" />
