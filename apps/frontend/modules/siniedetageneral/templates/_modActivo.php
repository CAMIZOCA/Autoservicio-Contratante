<div class="coursesMenuBox">
    ...
    <ul>
        <li <?php if('siniedetageneral' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniereclamtiposervic/index') ?>">Reclamo por tipo de servicio</a></li>
