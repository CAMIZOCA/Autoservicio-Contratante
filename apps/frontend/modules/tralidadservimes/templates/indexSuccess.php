            ...
            <div class="articleContentSector">
                ...
                <div class="breadcrumbBox">
                    <ul>
                        ...
                        <li class="last">Por Tipo servicio - Mes</li>
                    </ul>
                </div>
                <!-- TÍTULO DEL TEMA / TOPICO -->
                <h1 class="articleTitle">Por Tipo servicio - Mes</h1>
                    ...
                    <form target="#" id="form1" name="form1" >
                     <table>                      
                        <tr><td>Cliente: <input type="hidden" id="indicador" name="indicador" value="1"  /></td><td colspan="3"><select id="cliente" name="cliente" onChange="llenar_contratantes(this.value);">
                          ...
                          <tr><td>Contratante: </td><td colspan="3"><select id="contratante" name="contratante"  onChange="llenar_ano2(document.getElementById('cliente').value,this.value);document.forms.form1.localidad.disabled=false;" <?php if(trim($indicador)!=1){?> disabled ="true" <?php }?>>
                        ...
                        <tr><td>Año: </td>
                        <td colspan="3"><select id="ano" name="ano" onchange="" <?php if(trim($indicador)!=1){?> disabled ="true" <?php }?> >
                                    <option value="-1"  selected="seleted" > - Seleccione una opción - </option>
...
<script type="text/javascript">
    $(function() {
        $("#btn_getvalues").click(function() {
            ...
            $("#showTable").load("<?php echo url_for('tralidadservimes/gettable') ?>",{ 
