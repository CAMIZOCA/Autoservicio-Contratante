            ...
            <div class="articleContentSector">
                ...
                <div class="breadcrumbBox">
                    <ul>
                        ...
                        <li class="last">Parentesco - Mes + Localidad</li>
                    </ul>
                </div>
                <!-- TÍTULO DEL TEMA / TOPICO -->
                <h1 class="articleTitle">Parentesco - Mes + Localidad</h1>
...
<script type="text/javascript">
    $(function() {
        $("#btn_getvalues").click(function() {
            ...
            $("#showTable").load("<?php echo url_for('tralidadlocalparentesco/gettable') ?>",{ 
