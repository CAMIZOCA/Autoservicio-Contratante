...
function UltimoDia($anho,$mes){
 ...
 function validarMonto($var_monto){
                if (!$var_monto){
                    echo '0,00';
                }  else{
                    echo number_format(str_replace(",", ".",$var_monto),2,",",".");
                };
            };
...
<table class="tableSector" >
 ...
 <thead>
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_ene); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_ene); ?></td>
        ...
        <tr>
           ...
           <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_conyugue_feb),2,",","."); ?></td>   
            ...
            <td class="alignRight"><?php validarMonto($total_otros_feb); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_feb); ?></td>
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_mar); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_mar); ?></td>
        ...
        <tr>
           ...
           <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_conyugue_abr),2,",","."); ?></td>   
            ...
            <td class="alignRight"><?php validarMonto($total_otros_abr); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_abr); ?></td>
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_may); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_may); ?></td>
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_jun); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_jun); ?></td>
        ...
        <tr>
           ...
           <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_conyugue_jul),2,",","."); ?></td>   
            ...
            <td class="alignRight"><?php validarMonto($total_otros_jul); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_jul); ?></td>
...
<tr>
           ...
           <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_conyugue_ago),2,",","."); ?></td>   
            ...
            <td class="alignRight"><?php validarMonto($cantidad_hermanos_ago); ?></td>
            <td class="alignRight"><?php validarMonto($total_otros_ago); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_ago); ?></td>
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_sep); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_sep); ?></td>
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_oct); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_oct); ?></td>            
        ...
        <tr>
            ...
            <td class="alignRight"><?php validarMonto($total_otros_nov); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_nov); ?></td>
        ...
        <tr>
           ...
           <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_conyugue_dic),2,",","."); ?></td>   
            ...
            <td class="alignRight"><?php validarMonto($total_otros_dic); ?></td>
            <td class="alignRight"><?php validarMonto($cantidad_otros_dic); ?></td>
            <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_otros_dic),2,",","."); ?></td>
            <td class="alignRight"><?php echo number_format(str_replace(",", ".",$cantidad_otros_dic),2,",",".");?></td>
        ...
        <tr>
            ...
            <td class="alignRight"><?php echo number_format(str_replace(",", ".",$total_general_otros),2,",","."); ?></td>
            <td class="alignRight"><?php echo number_format(str_replace(",", ".",$cantidad_general_otros),2,",",".");?></td>
...
<input id="titulo_pdf"  name="titulo_pdf" type="text" value="Parentesco - Mes + Localidad" />
...
<input id="titulo"  name="titulo" type="text" value="Parentesco - Mes + Localidad" />
