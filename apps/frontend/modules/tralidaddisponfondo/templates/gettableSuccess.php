...
<div style="height:420px; margin-left:20px;" align="left">
    aqui esta la imagen
    <img src="https://chart.googleapis.com/chart?chs=250x100&chd=t:60,40&cht=p3&chl=Hello|World" width="200" />
...
<?php //if($cuantos_tabla_inicial!=0){echo $var_srcipt;}  ?>
