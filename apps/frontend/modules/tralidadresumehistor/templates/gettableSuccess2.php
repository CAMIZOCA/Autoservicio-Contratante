...
<table class="tableSector" cellpadding="0" cellspacing="0">
    <thead >
        <tr align="center">
        <th width="64"><div style="padding:5px">Mes</div></th>
        <th width="110"><div style="padding:5px">Saldo Anterior Fondo Bs</div></th>
        <th width="100"><div style="padding:5px">Aporte Fondos</div></th>
        <th width="110"><div style="padding:5px">Nª de Casos Incurridos</div></th>
        <th width="110"><div style="padding:5px">Monto Incurrido Total Bs</div></th>
        <th width="110"><div style="padding:5px">Monto Incurrido Acumulado Bs</div></th>
        <th width="110"><div style="padding:5px">Monto Incurrido Pendiente Mas Anterior Bs</div></th>
        <th width="100"><div style="padding:5px">Monto Indemnizado Bs</div></th>
        <th width="120"><div style="padding:5px">Ahorro Bs (Pronto Pago)</div></th>
        <th width="153"><div style="padding:5px">Disponibilidad de Fondos</div></th>
        </tr>
    </thead>
    <tbody>
<?php
...
?>
    ...
    <tfoot>
        ...
        <td class="alignRight"><?php echo number_format($total_saldo_anterior, 2, ",", "."); ?></td>
        ...
        <td class="alignRight"><?php echo number_format($total_incurrido_acum, 2, ",", "."); ?></td>
