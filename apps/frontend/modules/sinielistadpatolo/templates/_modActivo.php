<div class="coursesMenuBox">
    ...
    <ul>
        ...
        <li style="margin-left:10px;" <?php if('siniedetallpatolo' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniedetallpatolo/index') ?>">Detalle por patología</a></li>
