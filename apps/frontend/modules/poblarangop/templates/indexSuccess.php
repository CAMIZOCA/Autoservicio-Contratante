        ...
        <div id="contentBar">
            <div class="articleContentSector">
                ...
                <div class="breadcrumbBox">
                    <ul>
                        <li><a href="#">AutoServicio</a></li>
                        <!--                        <li><a href="#">Población</a></li>-->
                        <li class="last">Por rango de edad, parentesco y sexo</li>
                    </ul>
                </div>
                <!-- TÍTULO DEL TEMA / TOPICO -->
                <h1 class="articleTitle">Por rango de edad, parentesco y sexo</h1>
...
<script type="text/javascript">
    ...
    function cargarContenido(){
       // alert('s');
        ...
        $("#showTable").load("<?php echo url_for('poblarangop/gettable') ?>",{ 
