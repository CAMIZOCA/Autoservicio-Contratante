<div class="coursesMenuBox">
    ...
    <ul>
        ...
        <li style="margin-left:10px;" <?php if('siniedetaprove' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniedetaprove/index') ?>">Detalle por proveedor</a></li>
