<div class="coursesMenuBox">
    ...
    <ul>
        ...
        <li <?php if('siniedetalleprovee' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniedetalleprovee/index') ?>">Detalle por proveedor</a></li>
        ...
        <li <?php if('siniedetallfrecue' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniedetallfrecue/index') ?>">Detalle de listado de Frecuencia</a></li> 
    </ul>
</div>
