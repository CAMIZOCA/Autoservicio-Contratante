...
<ul>
        ...
        <!--<li style="margin-left:10px;" <?php if('siniedetallfrecue' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniedetallfrecue/index') ?>">Por Tipo servicio - Mes </a></li> 
        <li style="margin-left:10px;" <?php if('siniedetallfrecue' == $sf_context->getModuleName()) : echo 'class="current"'; endif; ?>><a href="<?php echo url_for('siniedetallfrecue/index') ?>">Por Tipo servicio - Mes + Localidad</a></li>
