            ...
            <div class="articleContentSector">
                ...
                <div class="breadcrumbBox">
                    <ul>
                        ...
                        <li class="last">Detalle de Listado por Patologías</li>
                    </ul>
                </div>
                <!-- TÍTULO DEL TEMA / TOPICO -->
                <h1 class="articleTitle">Detalle de Listado por Patologías</h1>
                    ...
                    <form  id="form1"  name="form1" action="<?php echo url_for('siniedetallpatolo/index') ?>" method="post">
                        <table>                      
                            ...
                            <tr><td>Tipo de Servicio: </td><td colspan="3">
                                <select id="tipo_servicio" name="tipo_servicio" onChange="llenar_ano2(document.getElementById('cliente').value,document.getElementById('contratante').value,document.getElementById('tipo_servicio').value);" <?php if (trim($indicador) != 1) { ?>  disabled ="true" <?php }if (trim($tipo_listado) == 1) { ?> class="deshabilitados" <?php } ?>>
                                    ...
                                    if ($tipo_servicio == 'todos') {
                                        ...
                                        ?> selected="seleted" <?php } ?> >Todos</option>
                            ...
                            <tr><td >Mes: </td><td colspan="3">
                                ...
                                <select id="mes"  name="mes" onchange="document.getElementById('tipo_servicio').disabled=false; fechas_mes(this.value,document.forms.form1.ano.value,'<?php echo $es_bisiesto; ?>');eliminarPais(document.forms.form1.inicio.value,document.forms.form1.fin.value), num_dias(this.value,document.forms.form1.ano.value);llenar_tipo_servicio(document.getElementById('cliente').value,document.getElementById('contratante').value,document.getElementById('ano').value,this.value);" <?php if (trim($indicador) != 1) { ?>  disabled ="true" <?php }if (trim($tipo_listado) == 1) { ?> class="deshabilitados" <?php } ?>>
                                    <option value="-1"  selected="seleted" > - Seleccione una opción - </option> 
                            ...
                            <div class="cajas_totales" >
                                <div class="cajitas_peq_totales">
                                    ...
                                    <div class="linea_media">
                                        ...
                                        <div class="total_bs"><?php echo number_format($promedio_casos_patolopromedio_casos_patolo, 2, ",", ".");   ?></div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    <?php if ($cuantos_tabla_inicial != 0) { ?>
                                        ...
                                        foreach ($SINIESTRALIDAD_VW_tabla_parcial as $row_tabla):
                                            ...
                                            if ($indicador == '1') {
                                                $url = 'siniedetalle/index?cliente=' . $cliente . '&contratante=' . $contratante . '&ano=' . $ano . '&mes=' . $mes2 . '&tipo_servicio=' . $tipo_servicio . '&servicio=' . $tipo_des . '&ci_paciente=' . $ci_paciente . '&clase_lis=4&indicador=' . $indicador . '';
                                            } else {
                                                $url = 'siniedetalle/index?cliente=' . $cliente . '&contratante=' . $contratante . '&ano=' . $ano . '&mes=' . $mes2 . '&tipo_servicio=' . $tipo_servicio . '&servicio=' . $tipo_des . '&ci_paciente=' . $ci_paciente . '&enfermedad=' . $enfermedad . '&clase_lis=5&tipo_lis=1';
                                            }
                                            ?>                                                                                              
...
//echo $var=ob_get_clean();
                            ...
                            if ($cuantos_tabla_inicial != 0) {
                                foreach ($SINIESTRALIDAD_VW_tabla_inicial as $row_tabla):
                                    ...
                                    $var.='<tr>      
                                                    ...
                                                    <td class="alignRight">' . number_format($monto, 2, ",", ".") . '</td></tr>';
                                endforeach;
                            }
                            ...
                            <form method="post" id="targetpdf" action="<?php echo url_for($dir) ?>" target="_blank" hidden="hidden">
                                <input id="titulo_pdf"  name="titulo_pdf" type="text" value="Detalle de Listado de Patologías por<?php echo ucfirst(strtr(strtolower($servicio_busca), "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÜÚ", "àáâãäåæçèéêëìíîïðñòóôõöøùüú")); ?>" />
...
// el enlace ya confeccionado realizamos lo siguiente.
                            ...
                            <table class="sectorBottomMenu">
                                ...
                                if (trim($tipo_listado) == '1') {
                                    $indicador = '1';
                                    $url_atras = '../sinielistadpatolo/index' . '?ano=' . $ano . '&mes=' . $mes . '&cliente=' . $cliente . '&contratante=' . $contratante . '&tipo_servicio=' . $tipo_servicio . '&indicador=1&pagina=' . $pagina_ubi;
                                    ?>
...
<script type="text/javascript">
    $(function() {
        ...
        $("#btn_getvalues").click(function() {
            ...
            /* $("#showTable").load("<?php echo url_for('siniedetallpatolo/gettable') ?>",{ 
